        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
          ...
          <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="aspect-video overflow-hidden rounded-2xl shadow-card">
              <iframe
                ...
                src="https://www.youtube.com/embed?listType=user_uploads&list=migrationpathway"
                title="Migration Pathway - Latest Video 1"
            ...
            <div className="aspect-video overflow-hidden rounded-2xl shadow-card">
              <iframe
                className="h-full w-full"
                src="https://www.youtube.com/embed?listType=user_uploads&list=migrationpathway&index=2"
                title="Migration Pathway - Latest Video 2"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              />
            </div>
            <div className="aspect-video overflow-hidden rounded-2xl shadow-card">
              <iframe
                className="h-full w-full"
                src="https://www.youtube.com/embed?listType=user_uploads&list=migrationpathway&index=3"
                title="Migration Pathway - Latest Video 3"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              />
            </div>
          ...
          <div className="mt-8 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-full border border-charcoal/20 px-6 py-3 text-sm font-semibold text-charcoal transition hover:border-charcoal"
            >
          ...
          <div className="grid gap-4 sm:gap-6 sm:grid-cols-2">
            <div className="card p-6">
              ...
              <p className="mt-3 text-sm text-slate">
                Service fees are non-refundable once the application process has been initiated. If a visa is refused due to reasons within our scope of responsibility, we will re-process your application at no additional charge.
              </p>
            </div>
            <div className="card p-6">
              <h3 className="text-lg font-semibold text-charcoal">Document Handling</h3>
              <p className="mt-3 text-sm text-slate">
                All personal documents provided to Migration Pathway are handled with strict confidentiality. We do not share your information with any third party without your explicit written consent.
              </p>
            </div>
            <div className="card p-6">
              <h3 className="text-lg font-semibold text-charcoal">Service Agreement</h3>
              <p className="mt-3 text-sm text-slate">
                Clients are required to sign a service agreement before we commence any application work. This agreement outlines the scope of services, timelines, fees, and responsibilities of both parties.
              </p>
            </div>
            <div className="card p-6">
              <h3 className="text-lg font-semibold text-charcoal">Communication Policy</h3>
              <p className="mt-3 text-sm text-slate">
                We commit to responding to all client inquiries within 24 business hours. Updates on your application status will be provided at each key milestone in the process.
              </p>
            </div>
            <div className="card p-6">
              <h3 className="text-lg font-semibold text-charcoal">Cancellation Policy</h3>
              <p className="mt-3 text-sm text-slate">
                Clients may cancel their application at any stage. However, fees for services already rendered (e.g., document review, application submission) are non-refundable.
              </p>
            </div>
            <div className="card p-6">
              <h3 className="text-lg font-semibold text-charcoal">Client Responsibility</h3>
              <p className="mt-3 text-sm text-slate">
                Clients must provide accurate and truthful information at all times. Migration Pathway is not liable for any delays or rejections resulting from inaccurate or incomplete information provided by the client.
              </p>
            </div>
          </div>
        </div>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            sameAs: [
              ...
              "https://whatsapp.com/channel/0029Vb8CWnkGU3BFQ3uq7W1H"
            ],
            contactPoint: [
              {
                "@type": "ContactPoint",
